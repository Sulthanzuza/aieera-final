  ...
  const features = [
    {
      ...
      description: "Anticipate emerging trends before they peak. Our AI forecasts search behaviors weeks in advance—so you're always one step ahead."
    },
    {
      icon: <Search className="w-8 h-8" />,
      title: "AI-Powered Intent Mapping",
      description: "Beyond keywords: identify searcher psychology and intent clusters in real time to drive conversion-focused content creation."
    },
    {
      icon: <Code className="w-8 h-8" />,
      title: "Dynamic Meta Intelligence",
      description: "Generate and deploy AI-optimized meta tags tailored to live search behavior—automatically and continuously."
    },
    {
      icon: <Activity className="w-8 h-8" />,
      title: "Real-Time SERP Monitoring",
      description: "Instantly adapt to SERP volatility, competitor shifts, and user behavior. Your content strategy evolves as fast as Google changes."
    }
  ];
